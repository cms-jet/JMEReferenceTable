...
process.slimmedJetsSmeared = cms.EDProducer('SmearedPATJetProducer',
        ...
        resolutionFile = cms.FileInPath('JetMETCorrections/JMEReferenceTable/data/Spring16_25nsV6_DATA_PtResolution_AK4PFchs.txt'),
        scaleFactorFile = cms.FileInPath('JetMETCorrections/JMEReferenceTable/data/Spring16_25nsV6_DATA_SF_AK4PFchs.txt'),
